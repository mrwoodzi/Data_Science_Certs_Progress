...
def update_output_container(selected_year, selected_statistics):
    if selected_statistics == 'Recession Period Statistics':
        ...
        selected_recession_data = recession_data[recession_data['Year'] == int(selected_year)]
        # Perform necessary calculations or visualizations with selected_recession_data
        output_text = f"Recession Period Statistics for Year {selected_year}: {selected_recession_data}"
        return output_text
