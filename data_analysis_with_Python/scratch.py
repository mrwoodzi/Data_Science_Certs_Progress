...
def calculate(list):
    ...
    stats_list = ['mean', 'variance', 'standard deviation', 'max', 'min', 'sum']
    if len(list) < 9 or len(list) > 9:
        ...
        mean = [axis0_stat, axis1_stat, axis2_stat, axis0, axis1, axis2, flattened_stat]
        variance = [axis0_var, axis1_var, axis2_var, axis0var, axis1var, axis2var, flattened_var]
        standard_deviation = [axis0_std, axis1_std, axis2_std, axis0std, axis1std, axis2std, flattened_std]
        max = [int(axis0_max), int(axis1_max), axis2_max, axis0max, axis1max, axis2max, flattened_max]
        min = [axis0_min, axis1_min, axis2_min, axis0min, axis1min, axis2min, flattened_min]
        sum = [axis0_sum, axis1_sum, axis2_sum, axis0sum, axis1sum, axis2sum, flattened_sum]
        stats = [mean, variance, standard_deviation, max, min, sum]
        for k, v in zip(stats_list, stats):
            calculations[k] = v
    return calculations
