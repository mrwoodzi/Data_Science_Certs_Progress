# Regular Expressions -  specifies a search pattern
# are a language unto themselves
# a language of "marker characters" - programming with characters
# kind of an "old school" language - compact
# to use you have to import so "import re" to import regex
# you can use re.search() to see if a string matches a regex
# you can use re.findall() to extract portions of a string that match your regex similar to find() and slicing var[5:10]
# re.search() returns a True/False depending on whether the string matches the regex
# re.findall() extracts the matching strings
# Greedy matching is when the program picks the bigger choice because it's bigger
# Searching for an escape character 
   # use \ and then the character you want
